...
<a href="sliders.php" class="btn btn-default" style="margin-left: 20px;">Go back</a>
    ...
    <?php $my_session->display_success(); ?>
        <img src="images/<?= $info[0]['image']?$info[0]['image']:'dumy.png' ?>" class="img thumbnail img-responsive" alt="" srcset="">
        <a href="./frontEnd/request/intrested.php?id=<?= $info[0]['temp']; ?>" class="btn btn-md btn-primary" style="display: block;margin:auto;margin-top:10px;border-radius:0%;width:100px">Intrested</a>
